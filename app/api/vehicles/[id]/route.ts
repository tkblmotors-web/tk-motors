...
// retrieve a PUBLISHED vehicle here. DRAFT/RESERVED/SOLD vehicles are only
// visible to authenticated ADMIN/EDITOR staff.
export async function GET(
  ...
  if (!authResult.ok && vehicle.status !== "PUBLISHED") {
